<div class="panel modal modal-fixed-footer nuevo" id="edicionAut">
    ...
    <div class="panel-footer">
        <div class="row">
        <div class="col-md-6 text-right"><button onclick="actualizarAutor()" class="waves-effect btn btn-success"><i class="fa fa-refresh"></i> Actualizar</button></div>
