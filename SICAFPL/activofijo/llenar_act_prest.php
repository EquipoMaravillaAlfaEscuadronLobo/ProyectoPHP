    ...
    foreach ($listado1 as $fila1) {
        ?>
            ...
            var sel = '<div class="form-group">' +
                    '<select class="form-control accion_select" onchange="activar_btn_act(this.value)" id="accion_select1[]" name="accion_select1[]">' +
            ...
            var sel = '<div class="form-group">' +
                    '<select class="form-control accion_select btn-success" onchange="activar_btn_act(this.value)"  id="accion_select1[]" name="accion_select1[]">' +                    
