<?php
        ...
        class PDF extends FPDF{
            function Header() {
                ...
                $this->Ln(2); 
                $this->Cell(100);
                $this->Cell(120,15,utf8_decode('Libros Extraviados'));
                $this->Cell(-135);
...
$listado1 = Repositorio_libros::LibrosExtraviados(Conexion::obtener_conexion());
...
$pdf->Cell(20);
$pdf->Cell(80, 6, utf8_decode('Código'), 1, 0, 'C');
$pdf->Cell(80, 6, utf8_decode('Título'), 1, 0, 'C');
//$pdf->Cell(50, 6, 'Motivo', 1, 0, 'C');
$pdf->Cell(80, 6, utf8_decode('Fecha de Publicación'), 1, 0, 'C');
$pdf->SetFont('Arial','',  10);
foreach ($listado1 as $fila1) {
    $pdf->Ln(6); 
    $pdf->Cell(20);
    $pdf->Cell(80, 6, $fila1['codigo'], 1, 0, 'C');
    $pdf->Cell(80, 6, utf8_decode($fila1['titulo']), 1, 0, 'C');
    //$pdf->Cell(10, 6, utf8_decode($fila1['motivo']), 1, 0, 'C');
    $pdf->Cell(80, 6, date_format(date_create($fila1['fecha']), 'd-m-Y'), 1, 0, 'C');
}
