<?php
        ...
        class PDF extends FPDF{
            function Header() {
                ...
                $this->Ln(2); 
                $this->Cell(100);
                $this->Cell(120,15,'Libros Dados de Baja');
                $this->Cell(-135);
...
$pdf->Cell(20);
$pdf->Cell(80, 6, 'Codigo', 1, 0, 'C');
$pdf->Cell(80, 6, 'Titulo', 1, 0, 'C');
$pdf->Cell(80, 6, 'Motivo', 1, 0, 'C');
...
foreach ($listado1 as $fila1) {
    ...
    $pdf->Cell(80, 6, utf8_decode($fila1['motivo']), 1, 0, 'C');
}
